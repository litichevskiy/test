...
var componentPageId = (function () {
    function componentPageId(dataServiceLanguage, dataService) {
        this.dataServiceLanguage = dataServiceLanguage;
        this.dataService = dataService;
    }
    componentPageId = __decorate([
        core_1.Component({
    ...
    return componentPageId;
}());
exports.componentPageId = componentPageId;
